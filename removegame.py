...
def find_item_in_list(what_user_wants_to_find, sad_history_hidden_list):
	...
	if try_again == False:
		print "Sorry that item is not in this history. Try again?"
	
		

def main(sad_history_hidden_list):
	"""Driver"""
sad_history_hidden_list =["bombs", "sadness", 'war', "trauma", "rape", "fear", "racism", "korean war", "apartied", "lalala"]#this will eventually be online
#synonyms of war for debugging warfare (has to be a noun)
#synonym of rape "sexual assault"
#anxiety synonym for fear
game_in_play = True
synonyms = [""]
if game_in_play:
	while game_in_play:
